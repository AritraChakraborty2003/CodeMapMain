        ...
        <div class="box">
            ...
            <div class="singup">
                ...
                <div class="singup-element">
                    ...
                    <input class="first-input" type="text" name="name">
                    <span class="email">E-mail </span>
                    <input class="email-box" type="text" name="email">
                    <span class="mobile">Password</span>
                    <input class="mobile-input" type="text" name="password">
                ...
                <div class="box-2">
                    <a class="already-account" href="login.php">Already have a account </a>
                </div>
            </div>
        </div>
    </div>
